...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    ZDDSHQSTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"qs"];
    if (!cell) {
        cell = [[ZDDSHQSTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"qs"];
    }
...
- (void)like1:(UIButton *)sender {
    ZDDSHQSTableViewCell *cell = (ZDDSHQSTableViewCell *)sender.superview.superview;
